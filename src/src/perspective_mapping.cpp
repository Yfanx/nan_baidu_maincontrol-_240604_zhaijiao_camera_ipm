...
//////////////////////////-------------------------  自己校核的参数240317
    ...
    //     m_origPoints.push_back(Point2f(33.0000 , 161.0000));   // 左下
    //     m_origPoints.push_back(Point2f(272.0000 , 164)); // 右下
    //     m_origPoints.push_back(Point2f(193.5221 ,  11.8514));   // 右上
    //     m_origPoints.push_back(Point2f(119.8120  , 10.0823));   // 左上

     
    //  m_dstPoints.clear();

    //     m_dstPoints.push_back(Point2f(119.0000 , 236)); // 左下
    //     m_dstPoints.push_back(Point2f( 207.0000,  237)); // 右下
    //     m_dstPoints.push_back(Point2f(205.0000 ,  10));   // 右上
    //     m_dstPoints.push_back(Point2f(120.0000 ,  12));   // 左上
   // 定义原图中的四个点和目标图像中对应的四个点

  // [第二版无带畸变镜头参数]   
       m_origPoints.clear();
  m_origPoints.push_back(Point2f(62.3182,  117.1093));   // 左下
    m_origPoints.push_back(Point2f(251.3108,  122.7113)); // 右下
    m_origPoints.push_back(Point2f(202.9570,   31.3108));   // 右上
    m_origPoints.push_back(Point2f(113.3256 ,  27.7727));   // 左上
    ...
    // The 4-points correspondences in the destination image
    m_dstPoints.clear();
    m_dstPoints.push_back(Point2f(125.4140 , 188.1658)); // 左下
    m_dstPoints.push_back(Point2f(  194.7015 , 188.7555)); // 右下
    m_dstPoints.push_back(Point2f(  188.8047 ,  79.0749));   // 右上
    m_dstPoints.push_back(Point2f( 130.4263  , 76.4214));   // 左上
